...
const Detail = () => {
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Text style={styles.pointName}>Mercadão do Igão</Text>
        <Text style={styles.pointName}>Orgânicos e òleo de cozinha</Text>

        <View style={styles.address}>
          <Text style={styles.addressTitle}>Endereço</Text>
          <Text style={styles.addressContent}>Osascão - SP</Text>
        </View>
      </View>
